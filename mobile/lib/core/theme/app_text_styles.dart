...
/// Styles typographiques TERANGA CIVIL — Refonte Pro.
abstract class AppTextStyles {
  AppTextStyles._();

  // ── Headings & Titres (Plus Jakarta Sans) ────────────────────────────────
  ...
  static TextStyle get buttonDisabled => GoogleFonts.plusJakartaSans(
        fontSize: 16, fontWeight: FontWeight.w600,
  ...
  static TextStyle get link => GoogleFonts.inter(
        fontSize: 14, fontWeight: FontWeight.w500,
        color: AppColors.info, height: 1.5,
  ...
  static TextStyle get tagline => GoogleFonts.inter(
        ...
        color: AppColors.textSecondary, height: 1.5, letterSpacing: 0.5);
